...
void Cpu::clock()
{
	if(cycles == 0)
	{
		opcode = read(pc); //read current opcode
		pc++;
...
// this is an encoding of the 6502 instruction set, mapping
// them to functions for opcode and address type.
...
using a = Cpu;
const std::vector<Cpu::Instruction> Cpu::lookup =
		{
